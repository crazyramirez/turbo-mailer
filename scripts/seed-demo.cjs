...
insertCampaign.run(
  'Lanzamiento Q1 2026', '🚀 Novedades Q1 — TurboMailer', 'email_demo', templateHtml,
...
const c1sends = [
  [1, 1,  'alice@techcorp.io',        '🚀 Novedades Q1 — TurboMailer', 'sent',   d(30), null],
  [1, 3,  'carol@marketingpro.es',    '🚀 Novedades Q1 — TurboMailer', 'opened', d(30), null],
  [1, 5,  'eva@consulting.eu',        '🚀 Novedades Q1 — TurboMailer', 'sent',   d(30), null],
  [1, 6,  'frank@ecommerce.shop',     '🚀 Novedades Q1 — TurboMailer', 'opened', d(30), null],
  [1, 8,  'hector@fintech.com',       '🚀 Novedades Q1 — TurboMailer', 'opened', d(30), null],
  [1, 9,  'iris@healthcare.org',      '🚀 Novedades Q1 — TurboMailer', 'sent',   d(30), null],
  [1, 11, 'kate@saas.dev',            '🚀 Novedades Q1 — TurboMailer', 'opened', d(30), null],
  [1, 15, 'oscar@logistics.eu',       '🚀 Novedades Q1 — TurboMailer', 'sent',   d(30), null],
  [1, 17, 'rafael@arquitectura.com',  '🚀 Novedades Q1 — TurboMailer', 'opened', d(30), null],
  [1, 18, 'sarah@globalhr.com',       '🚀 Novedades Q1 — TurboMailer', 'failed', null,  'SMTP 550: Mailbox unavailable'],
]
